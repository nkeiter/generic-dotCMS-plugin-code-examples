package org.example.nkeiter.login.as.log;
...
public class Logger extends com.dotmarketing.util.Logger
{
	...
	// Environment Keys
	public static final String DEVELOPMENT = "machine1";
	public static final String STAGE = "machine2";
	public static final String PRODUCTION = "machine3";
